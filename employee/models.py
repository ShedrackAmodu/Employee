...
class Employee(models.Model):
    ...
    # Update state field to use choices
    state = models.CharField(
        max_length=50,
        choices=[(state, state) for state in sorted(NIGERIAN_STATES_LGAS.keys())],
        help_text="Select state",
        verbose_name="State"
    )
    
    # LGA field will be dynamically validated in the form
